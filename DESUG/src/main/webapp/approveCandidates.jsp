                ...
                success: function(response) {
                    ...
                    $.each(response, function(index, candidate) {
                        var row = "<tr>" +
                            ...
                            "<td class='px-6 py-4'><a href='approveCandidateForm.jsp?registrationId=" + candidate.registrationNumber + "' class='font-medium text-blue-600 dark:text-blue-500 hover:underline'>Approve Candidate</a></td>" +
                            "</tr>";
