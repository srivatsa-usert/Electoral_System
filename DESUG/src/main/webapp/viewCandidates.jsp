...
<body class="flex flex-col min-h-screen">
    ...
    <div class="flex-grow p-6 bg-white dark:bg-gray-800">
        <!-- Table to display candidates info -->
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <table id="candidatesTable" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                success: function(response) {
                    ...
                    $.each(response, function(index, candidate) {
                        ...
                        var row = "<tr class='bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600'>" +
                            ...
                            "<td class='px-6 py-4'>" + candidate.course + "</td>" +
                            "</tr>";
                    ...
                    function getStatusText(status) {
                        if (status === "1") {
                            return "File Nomination Form Submitted";
                        } else if (status === "2") {
                            return "Enclosures Uploaded";
                        } else if (status === "3") {
                            return "Proposer & Seconder Accepted";
                        } else if (status === "3.5") {
                            return "Rejected by Proposer or Seconder";
                        } else if (status === "4") {
