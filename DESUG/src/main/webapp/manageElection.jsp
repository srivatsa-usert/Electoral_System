...
<div class="flex-grow">
    <div class="flex items-center justify-between m-10">
        ...
        <button id="createElectionButton" type="button" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Create Election</button>
    </div>
    <!-- form to create election -->
    <div id="newElectionForm" class="hidden flex items-center justify-between m-10">
        <form action="" method="post">
            <div class="flex items-center justify-between">
                <label for="electionName" class="text-gray-900 dark:text-gray-500">Election Name</label>
                <input type="text" id="electionName" name="electionName" class="w-96 border-gray-200 dark:border-gray-700 rounded-lg p-2.5 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" required>
            </div>
            <div class="flex items-center justify-between mt-5">
                <label for="startDate" class="text-gray-900 dark:text-gray-500">Start Date</label>
                <input type="date" id="startDate" name="startDate" class="w-96 border-gray-200 dark:border-gray-700 rounded-lg p-2.5 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" required>
            </div>
            <div class="flex items center justify-between mt-5">
                <label for="endDate" class="text-gray-900 dark:text-gray-500">End Date</label>
                <input type="date" id="endDate" name="endDate" class="w-96 border-gray-200 dark:border-gray-700 rounded-lg p-2.5 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" required>
            </div>
            <div class="flex items-center justify-between mt-5">
                <button type="submit" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Create Election</button>
            </div>
        </form>
    </div>
